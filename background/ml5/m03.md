...
- `sketch.js` (4) 
  - To do
    - [x] 한번만 말하게 하기
    - [ ] 여러 물체가 있는데 한 물체만 말을 하는 문제 해결해 보자 `sketch.js` (5) 
...
- `sketch.js` (5) 
  ...
  - To do
    - [x] 한번만 말하게 하기
    - [ ] 여러 물체가 있는데 한 물체만 말을 하는 문제 해결해 보자 ([Checking if the two arrays have same elements regardless of order](https://bobbyhadz.com/blog/javascript-check-if-two-arrays-have-same-elements#checking-if-the-two-arrays-have-same-elements-regardless-of-order))
